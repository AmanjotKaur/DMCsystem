...
urlpatterns = patterns('',
    ...
    url(r'^form/$', 'project.views.form'),
    url(r'^form1/$', 'project.views.fdata'),
    url(r'^form2/$', 'project.views.cerdata'),
    url(r'^form1/project.views.form/$', 'project.views.done'),
	#url(r'^done/$', 'project.views.done'),
    url(r'^form2/project.views.form/$', 'project.views.done'),
